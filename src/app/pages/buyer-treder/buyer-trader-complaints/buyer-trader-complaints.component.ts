...
@Component({
  ...
  templateUrl: './buyer-trader-complaints.component.html',
  styleUrls: ['./buyer-trader-complaints.component.css']
})
export class BuyerTraderComplaintsComponent implements OnInit {
