...
@Component({
  selector: 'app-chc-complaints',
  templateUrl: './chc-complaints.component.html',
  styleUrls: ['./chc-complaints.component.css']
})
export class ChcComplaintsComponent implements OnInit {
