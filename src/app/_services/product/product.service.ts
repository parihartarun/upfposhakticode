...
export class ProductService {
  ...
  fertilizerCreate(params) {
    return this.http.post<any>(this._url + 'inputSupplierIndent/fertilizer/create', { ...params });
  }
  machineryCreate(params) {
    return this.http.post<any>(this._url + '/inputSupplierIndent/machinery/create', { ...params });
  }
  insecticidesCreate(params) {
    return this.http.post<any>(this._url + 'inputSupplierIndent/insecticides/create', { ...params });
  }
  pesticidesCreate(params) {
    return this.http.post<any>(this._url + '/inputSupplierIndent/machinery/create', { ...params });
  }
