...
export const AdminLayoutRoutes: Routes = [
  ...
  { path: 'farmer-user-profile', component: FarmerUserProfileComponent },
  { path: 'farmer/complaints', component: FarmerComplaintsComponent },
  { path: 'buyer/complaints', component: FarmerComplaintsComponent },
  ...
  { path: 'buyer-user-profile', component: BuyeruserComponent },
